...
var MAC = {
    'Url': document.URL, 'Title': document.title, 'UserAgent': function () {
        ...
        'Init': function () {
            ...
            $('.mac_star').raty({
                starType: 'i', number: 5, numberMax: 5, half: true, score: function () {
        ...
        'Login': 0, 'Verify': 0, 'Init': function () {
            ...
            $.ajax({
                ...
                success: function ($r) {
                    ...
                    if ($r.code == 1) {
                        ...
                        window.location = maccms.path + '/index.php/user/login';
                    } else {
        ...
        'Logout': function () {
            $.ajax({
                type: 'post', url: maccms.path + '/index.php/user/logout', success: function ($r) {
                    alert($r.msg)
                    if ($r.code == 1) {
                        location.reload();
                    }
        ...
        'Show': function ($modalid, $url, $callback) {
            $.ajax({
                type: 'post', url: $url, timeout: 3000, error: function () {

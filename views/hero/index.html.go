...
<div class="container">
	...
	buffer.WriteString(`
                ...
                <ul class="hide">
                    ...
                    `)
	for _, recommend := range show["recommend"].([]interface{}) {
		buffer.WriteString(`
                    <li>
                        <a href='/movie?link=`)
		hero.EscapeHTML(recommend.(map[string]interface{})["link"].(string), buffer)
		buffer.WriteString(`'>
                            `)
		hero.EscapeHTML(recommend.(map[string]interface{})["name"].(string), buffer)
		buffer.WriteString(`
                        </a>
                    </li>
                    `)
